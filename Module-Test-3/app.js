...
let booksCardDiv = document.getElementById('bookCardWrapper');
let booksData;
...
searchButton.addEventListener("click",() => {
    ...
    fetch(url)
        ...
        // .catch(()=>{
        //     nameOfSearchedBook.innerText = `Book not found`
        // })
})
...
const historyPageButton = document.getElementById('historyPage')
